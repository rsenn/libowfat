...
size_t fmt_humank(char* dest,unsigned __int64 l) {
  char unit;
  size_t i;
  if (l<1000) return fmt_ulong(dest,l);
  if (l>1024*1024*1024*(unsigned __int64)1024) {
    l=(l+(1024*1024*1024*(unsigned __int64)1024/20))/(1024*1024*1024*(unsigned __int64)1024/10);
    unit='T';
