...
#ifndef __BORLANDC__
/* like fmt_long but for __int64 */
size_t fmt_longlong(char *dest,signed __int64 src) __pure__;

/* like fmt_ulong but for unsigned __int64 */
size_t fmt_ulonglong(char *dest,unsigned __int64 src) __pure__;

/* like fmt_xlong but for unsigned __int64 */
size_t fmt_xlonglong(char *dest,unsigned __int64 src) __pure__;
#endif
...
inline static size_t fmt_copybytes(char* dest,const char* src,size_t n) {
...
size_t fmt_human(char* dest,unsigned __int64 l) __pure__;

/* 1 -> "1", 4900 -> "4.8k", 2300000 -> "2.2M" */
size_t fmt_humank(char* dest,unsigned __int64 l) __pure__;
#endif
...
#ifndef __BORLANDC__
size_t fmt_asn1derlength(char* dest,unsigned __int64 l) __pure__;	/* 0-0x7f: 1 byte, above that 1+bytes_needed bytes */
size_t fmt_asn1dertag(char* dest,unsigned __int64 l) __pure__;	/* 1 byte for each 7 bits; upper bit = more bytes coming */

/* Google Protocol Buffers, https://developers.google.com/protocol-buffers/docs/encoding */
size_t fmt_varint(char* dest,unsigned __int64 l) __pure__;	/* protocol buffers encoding; like asn1dertag but little endian */
#endif
size_t fmt_pb_tag(char* dest,size_t fieldno,unsigned char type) __pure__;	/* protocol buffer tag */
#ifndef __BORLANDC__
size_t fmt_pb_type0_int(char* dest,unsigned __int64 l) __pure__;	/* protocol buffers encoding: type 0 bool/enum/int32/uint32/int64/uint64 */
size_t fmt_pb_type0_sint(char* dest,signed __int64 l) __pure__;/* protocol buffers encoding: type 0 sint32/sint64 */
#endif
...
#ifndef __BORLANDC__
size_t fmt_pb_int(char* dest,size_t fieldno,unsigned __int64 l) __pure__;
size_t fmt_pb_sint(char* dest,size_t fieldno,signed __int64 l) __pure__;
#endif
