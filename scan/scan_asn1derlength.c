...
size_t scan_asn1derlengthvalue(const char* src,size_t len,unsigned __int64* value) {
  unsigned int i,c;
  unsigned __int64 l;
...
size_t scan_asn1derlength(const char* src,size_t len,unsigned __int64* value) {
  unsigned __int64 l;
